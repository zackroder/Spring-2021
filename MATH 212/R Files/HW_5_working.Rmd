...
The trend apears to match the logged Johnson and Johnson data pretty well. The residual plot does not quite look white. We may need to include more controls in order to have a better fit model.
